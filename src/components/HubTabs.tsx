...
export const HubTabs: React.FC<HubTabsProps> = ({ activeTab, onChangeTab }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 px-2 pb-3 pt-1 bg-[#07070a]/95 md:relative md:bottom-auto md:left-auto md:right-auto md:px-0 md:pb-0 md:pt-0 md:bg-transparent md:mb-6 pointer-events-none md:pointer-events-auto">
      <div className="max-w-xl md:max-w-2xl mx-auto bg-[#0d0e12]/95 border border-[#2a2720] shadow-[0_-15px_35px_rgba(0,0,0,0.9)] md:shadow-[0_10px_35px_rgba(0,0,0,0.8)] p-1.5 rounded-2xl md:rounded-3xl flex items-center justify-around pointer-events-auto backdrop-blur-md">
        {tabs.map((t) => {
          const Icon = t.icon;
